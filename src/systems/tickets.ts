...
export default class Tickets {
    ...
    constructor(enabled: boolean = false, guildId: string, channelId: string, userId: string) {
    ...
    async reopenTicket() {
        return await this.db.userTicket.update({
            where: { id: this.userId, guilds: { some: { id: this.guildId, tickets: { some: { open: false } } } } },
            data: { guilds: { set: { id: this.guildId, tickets: [{ channelId: this.channelId, open: true }] } } }
        });
    }
